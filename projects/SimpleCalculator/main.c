...
void main (void)
{
	...
	u32 Local_u32FisrtDigit,Local_u32SecondDigit,Local_u32Result,Local_u32Temp;
	...
	while(1)
	{
		...
		if (Local_u8CurrentPose == 3)
		{
			...
			case 3 :
				//				Local_u32IntVal = Local_u32FisrtDigit / Local_u32SecondDigit;
				if(Local_u32FisrtDigit % Local_u32SecondDigit != 0)
				{
					Local_u8FloatFlag = 1;
					Local_u32Temp = Local_u32FisrtDigit*100;
					Local_u32Result = Local_u32Temp / Local_u32SecondDigit;
				}
				else
				{
					Local_u8FloatFlag = 0;
			...
			if(Local_u8FloatFlag == 1)
			{
				...
				CLCD_voidWriteNumber(Local_u32Temp,0,4);

				CLCD_voidGoToXY(0,5);
				CLCD_voidSendData('.');

				Local_u32Temp = Local_u32Result % 100;
				CLCD_voidWriteNumber(Local_u32Temp,0,6);
			}
