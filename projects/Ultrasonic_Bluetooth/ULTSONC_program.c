...
void Ultrasonic_Echo(void)
{
	...
	else
	{
		...
		ULTSONC_u16PulseWedth = Local_u16PulseEnd - Local_u16PulseStart;

		ULTSONC_u16Distance = ULTSONC_u16PulseWedth/466;

		if(ULTSONC_u16Distance <= ULTSONC_MinObstacle)
		{
			ULTSONC_u8ObstecalFlag = 1;
		}
		else
		{
			ULTSONC_u8ObstecalFlag = 0;
